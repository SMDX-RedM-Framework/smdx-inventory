...
function showBlur() {
    $.post('https://smdx-inventory/showBlur');
}
...
//     localStorage.setItem('smdx-inventory-color', color);
// }

// const savedColor = localStorage.getItem('smdx-inventory-color');
...
function FormatAttachmentInfo(data) {
    $.post(
        "https://smdx-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://smdx-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://smdx-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://smdx-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://smdx-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://smdx-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://smdx-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                ...
                if (
                    ...
                    $.post(
                        "https://smdx-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://smdx-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $.post("https://smdx-inventory/CloseInventory", JSON.stringify({}));
